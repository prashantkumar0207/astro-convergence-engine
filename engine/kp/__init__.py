...
Scope: KP_CHAIN_V1 (ADR-KP-001) - the exact-rational lordship chain
(sign lord SL, nakshatra/star lord NL, sub lord SB, sub-sub lord SS)
and KP chart assembly. Significators, four-step, ruling planets,
horary, and dashas are OUT of scope and do not exist here.
"""
