...
certified sidereal position pipeline, so event instants inherit the
Tier-0 certification. No aspect systems, no interpretation, no
dasha-transit convergence (explicit non-claims).
"""
