...
def gate_d_non_invasiveness():
    ...
    if get_varga_rule(12, "parashara") is not D12_PARASHARA:
        fail("registered D12 rule is not the certified module object")
    ...
    return {
        ...
        "refusals": "intact",
        "registered_rule_identity": "is D12_PARASHARA",
        "rule_content_sha256": rule_content_sha256(D12_PARASHARA),
