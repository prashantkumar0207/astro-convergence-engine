...
def gate_d_non_invasiveness():
    ...
    if get_varga_rule(2, "parashara") is not D2_PARASHARA:
        fail("registered D2 rule is not the certified module object")
    ...
    return {
        ...
        "refusals": "intact",
        "registered_rule_identity": "is D2_PARASHARA",
        "rule_content_sha256": rule_content_sha256(D2_PARASHARA),
...
def main():
    ...
    out = support.emit(report, "VARGA_D2_V1_certification.json", "varga_d2", tee)
    print("=" * 60)
