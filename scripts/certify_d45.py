...
def gate_d_non_invasiveness():
    ...
    for division in (4, 16, 27, 60):  # D24, D40 excluded: certified/registered (ADR-0082/0083, VARGA_D24_V1; ADR-0087, VARGA_D40_V1); D20 removed: production-registered (ADR-0095)
        try:
