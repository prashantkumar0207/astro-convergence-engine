...
| Field | Value |
|---|---|
| Status | ACTIVE REGISTER. **ACCEPTED (25): ADR-0001, ADR-0002, ADR-0005, ADR-0006, ADR-0007, ADR-0008, ADR-0009, ADR-0010, ADR-0011, ADR-0012, ADR-0033 through ADR-0037, ADR-0039 through ADR-0042, ADR-0044, ADR-0045, ADR-0046, ADR-0048, ADR-0049, and ADR-0050**, owner-ratified across 2026-08-13, 2026-08-14 and 2026-08-17. Tier-0 is **FORMALLY LOCKED** (ADR-0034), the only s12 Locked artifact. The registry vargas and the sign conventions are **owner-ratified but NOT s12 Locked** (ADR-0035 D3, ADR-0036 D3). **Q8 is now CLOSED** (ADR-0048): the ratified roadmap-governance matrix is `docs/Q8_CLOSURE_MATRIX.md`; phase entry is not thereby authorised. **Phase G's B-01/B-02/B-03 blockers (ADR-0049) and G7 stale documentation (ADR-0050) are RESOLVED; Phase G itself is still NOT an exit candidate.** The reserved `ADR-0015`, `ADR-0016` and `ADR-0017` are now **DRAFTED and PROPOSED** (this pass, 2026-08-17): G2 (charter adoption) awaits owner adoption of `specs/PROJECT_CHARTER.md`; G3 (precedence hierarchy/agent workflow) records `ADR-0042` as already satisfying the hierarchy half and proposes ratifying `specs/CLAUDE_WORKFLOW.md` for the workflow half; G5 (certification taxonomy) is a proposed C0-C5 scheme awaiting six named owner decisions - **none of the three is ratified, and none is self-ratifying by being drafted.** DP-001 remains RESERVED at the paper-index level but is now drafted as `docs/decisions/DP-001-owner-ratification-and-mechanism.md`, presenting a disposition option rather than deciding it. **Still PROPOSED: ADR-0003, ADR-0004, ADR-0013, ADR-0014, ADR-0015, ADR-0016, ADR-0017, ADR-0018 through ADR-0032, ADR-0038, and ADR-0047.** Ratification is now possible, because Q1 named an owner; ratification is per-entry, and an owner existing is not the register being ratified. Includes the ADR-0018 remote-CI evidence addendum (2026-08-11). |
| Version | 2.3.0 |
...
- **Date:** 2026-08-17
- **Status:** PROPOSED - pending owner ratification/adoption. Prepared on the owner's explicit direction to prepare this reserved entry for review ("CEO GOVERNANCE AUTHORIZATION - COMPLETE REMAINING PHASE G EXIT WORK"). This entry does not self-ratify; per `docs/PROJECT_CONSTITUTION.md` s11 and this session's own instruction, only the owner adopts a charter.
...
- **Date:** 2026-08-17
- **Status:** PROPOSED - pending owner ratification. The precedence-hierarchy component (Decision 1) states an already-ratified fact and requires only owner acknowledgement that it closes this reserved slot's corresponding half; the agent-workflow component (Decision 3) is genuinely new proposed policy and requires a full owner ratification act, most directly by ratifying `specs/CLAUDE_WORKFLOW.md` itself.
...
- **Date:** 2026-08-17
- **Status:** PROPOSED - pending owner ratification. This entry does **not** claim `ADR-0017` already exists, is ratifiable as written, or is self-ratified by being drafted. Sections 2 and 4 below are labelled proposed policy, explicitly distinguished from sections 1 and 3's attested facts and gaps, per owner instruction.
