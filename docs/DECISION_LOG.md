...
| Field | Value |
|---|---|
| Status | ACTIVE REGISTER. **ACCEPTED (29): ADR-0001, ADR-0002, ADR-0005 through ADR-0012, ADR-0015, ADR-0016, ADR-0017, ADR-0033 through ADR-0037, ADR-0039 through ADR-0042, ADR-0044, ADR-0045, ADR-0046, ADR-0048, ADR-0049, ADR-0050, and ADR-0051**, owner-ratified across 2026-08-13, 2026-08-14 and 2026-08-17. Tier-0 is **FORMALLY LOCKED** (ADR-0034), the only s12 Locked artifact. The registry vargas and the sign conventions are **owner-ratified but NOT s12 Locked** (ADR-0035 D3, ADR-0036 D3). **Q8 is now CLOSED** (ADR-0048). **Phase G's B-01/B-02/B-03 blockers (ADR-0049), G7 stale documentation (ADR-0050), G2 charter adoption, G3 precedence hierarchy/agent workflow, and G5 C0-C5 certification taxonomy (all three ADR-0051, 2026-08-17) are RESOLVED.** `specs/PROJECT_CHARTER.md` is the adopted Project Charter (subordinate to `docs/PROJECT_CONSTITUTION.md`, which remains the governing constitution); `specs/CLAUDE_WORKFLOW.md` is the ratified agent-workflow specification (subordinate to the `ADR-0042` hierarchy, not an independent authority); the C0-C5 table in `ADR-0051` Decision 3 is the binding certification-claim classification, with `PROJECT_CONSTITUTION.md` s12 "Locked" kept explicitly orthogonal to it. `DP-001` is drafted and dispositioned (`ADR-0051` Decision 4): the ratification-mechanism half cites `ADR-0033` D1 and established precedent; the named-owner half designates the Project Owner as interim docs/engine/release owner pending explicit delegation. **See this session's evidence report for the independently-verified Phase G exit determination** - this header records ratification status, not an exit declaration. **Still PROPOSED: ADR-0003, ADR-0004, ADR-0013, ADR-0014, ADR-0018 through ADR-0032, ADR-0038, and ADR-0047.** Ratification is per-entry; an owner existing is not the register being ratified. Includes the ADR-0018 remote-CI evidence addendum (2026-08-11). |
| Version | 2.4.0 |
