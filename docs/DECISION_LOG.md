...
| Field | Value |
|---|---|
| Status | ACTIVE REGISTER. **ACCEPTED (32): ADR-0001, ADR-0002, ADR-0005 through ADR-0012, ADR-0015, ADR-0016, ADR-0017, ADR-0033 through ADR-0037, ADR-0039 through ADR-0042, ADR-0044, ADR-0045, ADR-0046, ADR-0048 through ADR-0054**, owner-ratified across 2026-08-13, 2026-08-14, 2026-08-17 and 2026-08-18. Tier-0 is **FORMALLY LOCKED** (ADR-0034), the only s12 Locked artifact. The registry vargas and the sign conventions are **owner-ratified but NOT s12 Locked** (ADR-0035 D3, ADR-0036 D3). **Q8 is now CLOSED** (ADR-0048); **Phase G exited and FOUNDATION entry criteria were independently confirmed satisfied** (this session's evidence reports). **FOUNDATION's first work package, rise/set, is CERTIFIED (`ADR-0054`, `RISE_SET_V1`)**: five owner-ratified conventions (upper-limb disc, standard -50' refraction, elevation accounted for, structured NO_RISE/NO_SET, conventions in `CalculationProfile`/`BirthData`), zero calculation impact on any existing certified capability, two genuine defects found and fixed during its own construction (recorded in the entry). **No downstream FOUNDATION capability (panchanga, Rahu Kalam/Yamaganda/Gulika, H-01, H-02) or any later phase is thereby authorised** - `docs/Q8_CLOSURE_MATRIX.md` s4 requires its own per-capability checkpoint for each. **Still PROPOSED: ADR-0003, ADR-0004, ADR-0013, ADR-0014, ADR-0018 through ADR-0032, ADR-0038, and ADR-0047.** `ADR-0047`'s originally-reported G5 sample accounting (22/22 complete, 16 independent, 14 events) was **incorrect and is corrected by its own evidence addendum (2026-08-18)**: the corrected executed state is 12/22 attempted, 4 confirmed independent, 2 ADB_MATCH, 1 NO_MATCH, 1 AMBIGUOUS, 4 resolved-but-ADB-unchecked (not independent), 15 unattempted; `ADR-0047` remains PROPOSED, not ratified. Ratification is per-entry; an owner existing is not the register being ratified. Includes the ADR-0018 remote-CI evidence addendum (2026-08-11) and the ADR-0047 corrected-accounting addendum (2026-08-18). |
| Version | 2.8.0 |
