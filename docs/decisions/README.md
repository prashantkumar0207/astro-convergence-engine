...
| DP-017 | H-06 (`docs/DASHA_CERTIFICATION_ROADMAP.md` step 3): no allow-list for dasha profiles, no type enforcement on `year_length_days` - whether and how to close the gap | JATAKA entry criteria (`Q8_CLOSURE_MATRIX.md` s5); `VIMSHOTTARI_V1` profile-certification coverage | OPEN, drafted |
