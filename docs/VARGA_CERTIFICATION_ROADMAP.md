...
through the registry), and **eight** divisions through the registry under the `parashara` school key -
D2, D3, D7, D12, D24, D30, D40, D45. The sanctioned set is the single constant
