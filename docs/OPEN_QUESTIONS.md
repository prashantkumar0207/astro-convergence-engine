...
| Field | Value |
|---|---|
| Status | ACTIVE REGISTER. Sixteen questions: thirteen open, three with candidate resolutions awaiting ratification. Nothing in this register is ratified, because Q1 is itself open. |
| Version | 0.6.0 |
...
`docs/DECISION_LOG.md`, including ADR-0022 through ADR-0032 which were written to resolve the
ADR-0013 conflicts, to disposition the earlier register, to correct the numbering gate, and to
repair and complete the Tier-0 certification evidence, is PROPOSED. A reader must not treat any entry below as settled.
...
| Q16 | ADR-0032, implemented and gated | 2026-08-13 | Q1 open; ADR is PROPOSED |
