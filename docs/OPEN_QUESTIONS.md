...
| Field | Value |
|---|---|
| Status | ACTIVE REGISTER. Seventeen questions. **First owner ratifications recorded 2026-08-13 (ADR-0033): Q13 resolved; Q1 and Q8 ratified in part.** Twelve fully open, three with candidate resolutions awaiting a ratification decision, two ratified in part. An owner now exists, so ratification is possible; it is per-entry and has been given three times only. |
| Version | 1.0.0 |
...
| Q17 | The owner states whether s12 condition 4 requires a ratified decision entry or merely an existing one. If ratified, the stricter reading ADR-0033 D4 adopted stands. If merely existing, ADR-0033 D4's Tier-0 assessment is reopened and must be redone. | **Owner only.** It is an interpretation of the owner's own constitution. |
